                    ...
                    <form id="contactForm" method="post" action="<?= base_url('contact/submit') ?>" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <!-- <div class="g-recaptcha mb-3" data-sitekey="<//?= env('recaptcha.siteKey') ?>"> -->
                                <div class="g-recaptcha" data-sitekey="<?= env('RECAPTCHA_SITE_KEY') ?>"></div>
                            </div>

                            <div id="captchaError" class="form-error">
                            </div>

                        </div>

                        <div class="col-12">
                            <button id="contactSubmitBtn" class="btn btn-primary rounded-pill py-3 px-5" type="submit">
                                Send Message
                            </button>
                        </div>
