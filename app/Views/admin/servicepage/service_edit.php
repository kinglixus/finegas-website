        ...
        <div class="page-header-breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    ...
                    <a href="<?= base_url('admin/servicepage/services') ?>">
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Update service information displayed on the Services page.
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/servicepage/update-service/' . $service['id']) ?>" method="post"
