...
<div class="page-header">
    <div class="page-header-left">
        <h4 class="page-title">Page Header</h4>
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <h5 class="card-title mb-1">About Page Header Section</h5>
                    <p class="text-muted mb-0">
                        Manage the About Us page banner, title, and header content.
                    </p>
                </div>
            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <img id="imagePreview" src="<?= !empty($pageHeader['image'])
                                    ...
                                    class="img-thumbnail" style="width: 320px; height: 180px; object-fit: cover;">
                            </div>
                        </div>
